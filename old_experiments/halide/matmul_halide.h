#ifndef HALIDE__matmul_halide_h
#define HALIDE__matmul_halide_h
#include <stdint.h>
...
int matmul(struct halide_buffer_t *_A_buffer, struct halide_buffer_t *_B_buffer, struct halide_buffer_t *_matmul_buffer);
